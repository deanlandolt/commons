...
var NativeBinary = require("../binary").NativeBinary;
...
exports.str2binl = function (str, _characterSize) {
    _characterSize = _characterSize || exports.characterSize;
    var bin = [];
...
exports.binl2hex = function (binarray, _alphabet16) {
    _alphabet16 = _alphabet16 || exports.alphabet16;
    var str = "";
